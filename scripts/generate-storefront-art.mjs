...
function titleOverlay(width, height, layout) {
  ...
  const tourSize = portrait ? width * 0.044 : height * 0.068;
  ...
  return svgData(`
    <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#shadow)" font-family="Impact, Haettenschweiler, sans-serif" text-anchor="${anchor}">
        ...
        <text x="${titleX}" y="${subtitleY}" font-family="Arial, sans-serif" font-size="${tourSize}" font-weight="900" letter-spacing="${tourSize * 0.16}" fill="#ffffff">UNDERGROUND GOLF TOUR</text>
      </g>
